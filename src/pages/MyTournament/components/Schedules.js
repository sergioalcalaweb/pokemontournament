...
const Schedules = ({
  ...
  const handleMatchDblClick = (matchInfo) => {     
    if(matchInfo.close && user.admin ) {
      setMatch(matchInfo);
      setOpenConfirm(true);
    }
  }
  ...
  const handleRemove = async () => {    
    ...
    showNotification('Juego anulado');
  }
  ...
  return (
    <Fade in>
      <Container>
                      ...
                      return (
                        <React.Fragment key={index}>
                          <ListItem button                             
                            ...
                            {
                              match.close && user.admin && (
                                <ListItemSecondaryAction>
                                  <Tooltip title="Quitar Resultado">
                                    <IconButton onClick={ () => handleMatchDblClick(match) } edge="end" aria-label="delete">
                                      <RemoveCircleIcon />
                                    </IconButton>
                                  </Tooltip>
                                </ListItemSecondaryAction>
        ...
        { match && (<DialogConfirmation open={openConfirm} onClose={handleClose} onAccept={handleRemove} />)}        
      </Container>
    </Fade>
  )
}
